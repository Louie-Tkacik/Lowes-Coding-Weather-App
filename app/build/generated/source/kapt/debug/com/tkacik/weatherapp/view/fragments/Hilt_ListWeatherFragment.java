...
public abstract class Hilt_ListWeatherFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListWeatherFragment() {
    super();
  }

  Hilt_ListWeatherFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListWeatherFragment_GeneratedInjector) this.generatedComponent()).injectListWeatherFragment(UnsafeCasts.<ListWeatherFragment>unsafeCast(this));
    }
  }
