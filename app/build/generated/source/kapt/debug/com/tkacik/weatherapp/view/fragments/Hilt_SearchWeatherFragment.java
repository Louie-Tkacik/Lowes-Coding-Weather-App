...
public abstract class Hilt_SearchWeatherFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchWeatherFragment() {
    super();
  }

  Hilt_SearchWeatherFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchWeatherFragment_GeneratedInjector) this.generatedComponent()).injectSearchWeatherFragment(UnsafeCasts.<SearchWeatherFragment>unsafeCast(this));
    }
  }
