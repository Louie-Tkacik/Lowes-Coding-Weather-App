...
public abstract class Hilt_DetailWeatherFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetailWeatherFragment() {
    super();
  }

  Hilt_DetailWeatherFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetailWeatherFragment_GeneratedInjector) this.generatedComponent()).injectDetailWeatherFragment(UnsafeCasts.<DetailWeatherFragment>unsafeCast(this));
    }
  }
