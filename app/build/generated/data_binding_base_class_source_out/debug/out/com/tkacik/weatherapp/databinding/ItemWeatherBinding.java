...
public final class ItemWeatherBinding implements ViewBinding {
  ...
  private ItemWeatherBinding(@NonNull ConstraintLayout rootView, @NonNull Guideline glCenter,
      @NonNull MaterialTextView tvForecast, @NonNull MaterialTextView tvTemp) {
  ...
  public static ItemWeatherBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemWeatherBinding((ConstraintLayout) rootView, glCenter, tvForecast, tvTemp);
    }
